...
<title>Admin - Update Underwriter Password</title>
<style>
body {
...
<body>
    ...
    <div class="content" id="content">
        <h2 id="welcome">Update Underwriter Password</h2>
        <form id="updatePasswordForm" action="AdminServlet?action=doUpdate" method="POST" onsubmit="return validateForm()">
        ...
        <div class="result" id="result">
            <% String isUpdatedMessage = (String) request.getAttribute("isUpdatedMessage"); %>
            <% if (isUpdatedMessage != null) { %>
                <p><strong style="color: red;"><%= isUpdatedMessage %></strong></p>
            <% } %>
        </div>
    </div>
        ...
        function validateForm() {
            ...
            if (!passwordRegex.test(newPassword)) {
                document.getElementById("newPasswordError").textContent = 
                    "Password must be at least 8 characters long, contain both lowercase and uppercase letters, and include at least one number and special character.";
                isValid = false;
            } else {
                document.getElementById("newPasswordError").textContent = "";
            }
